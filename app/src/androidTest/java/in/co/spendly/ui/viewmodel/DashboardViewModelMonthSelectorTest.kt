package `in`.co.spendly.ui.viewmodel
...
import `in`.co.spendly.ui.screens.dashboard.DashboardUiState
import `in`.co.spendly.ui.screens.dashboard.DashboardViewModel
...
class DashboardViewModelMonthSelectorTest {
    ...
    private lateinit var expenseDao: `in`.co.spendly.data.local.dao.ExpenseDao
    private lateinit var incomeDao: `in`.co.spendly.data.local.dao.IncomeDao
