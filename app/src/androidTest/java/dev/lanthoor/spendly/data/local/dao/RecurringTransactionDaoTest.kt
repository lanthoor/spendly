...
import dev.lanthoor.spendly.utils.daysAgo
import dev.lanthoor.spendly.utils.daysFromNow
...
class RecurringTransactionDaoTest {
    ...
    fun insertRecurringTransaction_withValidData_returnsInsertedId() = runTest {
        // Arrange
        val category =
            TestDataBuilders.createTestCategoryEntity(name = "Rent-${System.currentTimeMillis()}")
    ...
    fun insertRecurringTransaction_withPaiseAmount_exactMatch() = runTest {
        ...
        val category =
            TestDataBuilders.createTestCategoryEntity(name = "Test-${System.currentTimeMillis()}")
        val categoryId = categoryDao.insert(category)
    ...
    fun deleteRecurringTransaction_removesFromDatabase() = runTest {
        ...
        val recurring =
            TestDataBuilders.createTestRecurringTransactionEntity(categoryId = categoryId)
        val id = dao.insert(recurring)
