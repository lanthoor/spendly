...
data class Category(
    ...
    companion object {
        /**
         * Predefined categories (14 total) as per PLAN.md task 79.
        ...
        val PREDEFINED = listOf(
            ...
            Category(7, "Entertainment", "movie", 0xFF54A0FF.toInt(), false, 7),
            ...
            Category(13, "Others", "more_horiz", 0xFFB8B8B8.toInt(), false, 13),
            Category(14, "Uncategorized", "category", 0xFF9E9E9E.toInt(), false, 14)
        )

        /**
         * Default category ID for transactions without a category.
         */
        const val UNCATEGORIZED_ID = 14L
    }
}
