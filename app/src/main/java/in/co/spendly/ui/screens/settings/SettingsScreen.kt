...
import `in`.co.spendly.ui.components.LockTimeoutDropdown
import `in`.co.spendly.ui.components.ThemeSegmentedButton
            ...
            item {
                ...
                val scanNowLauncher = rememberLauncherForActivityResult(
                    ...
                    if (allGranted) {
                        ...
                        val request =
                            androidx.work.OneTimeWorkRequestBuilder<`in`.co.spendly.workers.HistoricalSmsScanWorker>()
                                .addTag(`in`.co.spendly.workers.HistoricalSmsScanWorker.WORK_TAG)
                                .build()
                        wm.enqueue(request)
                    } else {
                        showPermissionDialog = true
