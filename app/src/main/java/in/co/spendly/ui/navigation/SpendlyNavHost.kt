...
import `in`.co.spendly.ui.screens.accounts.AccountListScreen
import `in`.co.spendly.ui.screens.accounts.EditAccountScreen
import `in`.co.spendly.ui.screens.analytics.AnalyticsScreen
import `in`.co.spendly.ui.screens.dashboard.DashboardScreen
import `in`.co.spendly.ui.screens.datamanagement.DataManagementScreen
import `in`.co.spendly.ui.screens.expenses.AddExpenseScreen
import `in`.co.spendly.ui.screens.expenses.EditExpenseScreen
import `in`.co.spendly.ui.screens.income.AddIncomeScreen
import `in`.co.spendly.ui.screens.income.EditIncomeScreen
import `in`.co.spendly.ui.screens.recurring.RecurringTransactionListScreen
import `in`.co.spendly.ui.screens.settings.AboutScreen
import `in`.co.spendly.ui.screens.settings.BudgetSettingsScreen
import `in`.co.spendly.ui.screens.settings.LanguageSettingsScreen
import `in`.co.spendly.ui.screens.settings.SettingsScreen
import `in`.co.spendly.ui.screens.transactions.TransactionListScreen
