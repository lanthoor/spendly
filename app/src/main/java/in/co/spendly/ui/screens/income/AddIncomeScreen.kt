package `in`.co.spendly.ui.screens.income
...
import `in`.co.spendly.ui.screens.income.components.IncomeFormFields
import `in`.co.spendly.ui.screens.income.components.RefundExpensePicker
...
fun AddIncomeScreen(
    ...
    if (formState.isSubmitting) {
        LoadingIndicator(
            message = stringResource(R.string.label_saving_income),
            modifier = Modifier
                .fillMaxWidth()
                .padding(64.dp)
        )
        ...
        Column(
            ...
            // Title
            Text(
                text = stringResource(R.string.screen_add_income_title),
            ...
            Column {
                ...
                Button(
                    ...
                    Text(stringResource(R.string.button_save_income))
                }
