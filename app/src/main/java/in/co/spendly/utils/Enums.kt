...
enum class AppLanguage(val code: String, val displayNameRes: Int) {
    ENGLISH("en", `in`.co.spendly.R.string.language_english),
    HINDI("hi", `in`.co.spendly.R.string.language_hindi),
    MALAYALAM("ml", `in`.co.spendly.R.string.language_malayalam);
