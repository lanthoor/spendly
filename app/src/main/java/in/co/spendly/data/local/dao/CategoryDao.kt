...
interface CategoryDao {
    ...
    /**
     * Get all categories as a snapshot (one-shot query for export).
     ...
     * Used during import to clear user-created categories before restoring.
     * Predefined categories (is_custom = 0) are preserved.
     */
