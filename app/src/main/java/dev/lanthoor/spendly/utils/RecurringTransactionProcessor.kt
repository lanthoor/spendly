...
class RecurringTransactionProcessor @Inject constructor(
    ...
    suspend fun processRecurringTransactions(currentDate: Long = System.currentTimeMillis()) {
        ...
        val recurringTransactions =
            recurringTransactionRepository.getAllRecurringTransactions().first()
    ...
    private suspend fun createTransaction(
        transaction: dev.lanthoor.spendly.domain.model.RecurringTransaction,
        occurrenceDate: Long
    ) {
        when (transaction.transactionType) {
            ...
            "INCOME" -> {
                val income = Income(
                    ...
                    source = IncomeSource.OTHER, // Default source for recurring income
                    date = occurrenceDate,
                    description = transaction.description,
                    accountId = transaction.accountId,
